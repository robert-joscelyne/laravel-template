...
<head>
   ...
   <link href="css/evacguide.css" rel="stylesheet" type="text/css" />
...
<div class="row banner">
   <div class="span12 relative">
      ...
      <div class="account signin absolute">
         ...
         <a href="/login.html" class="vpb_general_button button">SIGN IN NOW</a>
      </div>
...
<div class="row content">
   <div class="span12">
      ...
      <table class="table table-bordered">
         <tbody>
         <tr>
            <td>Are you conducting regular emergency planning meetings</td>
            <td></td>
            <td>YES
         ...
         <tr>
            <td>Do you have an up-to-date register of emergency contact numbers</td>
            <td></td>
            <td>YES
         ...
         <tr>
            <td>Do you keep an accurate register of all Emergency Control Organisation members (wardens)</td>
            <td></td>
            <td>YES
               <input name="1" type="radio" value="Yes" id="Yes" style="margin-bottom:6px;" /></td>
            <td>NO
         ...
         <tr>
            <td>Are your emergency response procedures readily accessible</td>
            <td></td>
            <td>YES
               <input name="1" type="radio" value="Yes" id="Yes" style="margin-bottom:6px;" /></td>
            <td>NO
         ...
         <tr>
            <td>Are evacuation diagrams valid and compliant</td>
            <td></td>
         ...
         <tr>
            <td>Is there a scheduled emergency response training program for staff</td>
            <td></td>
            <td style="margin:6px 0px 0px 0px;">YES
               <input name="1" type="radio" value="Yes" id="Yes" style="margin-bottom:6px;" /></td>
            <td>NO
