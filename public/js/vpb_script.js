...
{	
	$("#vpb_pop_up_background").click(function()
	{
		...
		$("#vpb_contact_pop_up_box").hide(); //Hides the contact-up box when clicked outside the form
...
//This function displays the contact-up box when called
function vpb_show_contact_up_box()
{
	$("#vpb_pop_up_background").css({
		"opacity": "0.4"
	});
	$("#vpb_pop_up_background").fadeIn("slow");
	$("#vpb_contact_pop_up_box").fadeIn('fast');
	window.scroll(0,0);
}
